...
**更新** 本次更新重点关注SDK实例跟踪机制，区分chatConn连接实例和chatSDK SDK静态实例，提供更完善的连接状态管理。
...
- [ChatUIKit/stores/conversation.ts](file://ChatUIKit/stores/conversation.ts#L1-L200)
- [ChatUIKit/stores/message.ts](file://ChatUIKit/stores/message.ts#L1-L200)
- [ChatUIKit/stores/contact.ts](file://ChatUIKit/stores/contact.ts#L1-L200)
- [ChatUIKit/stores/group.ts](file://ChatUIKit/stores/group.ts#L1-L200)
...
**图表来源**
- [ChatUIKit/stores/chat.ts](file://ChatUIKit/stores/chat.ts#L299-L345)
- [ChatUIKit/stores/conn.ts](file://ChatUIKit/stores/conn.ts#L46-L81)
...
**图表来源**
- [ChatUIKit/stores/chat.ts](file://ChatUIKit/stores/chat.ts#L58-L88)
- [ChatUIKit/stores/conn.ts](file://ChatUIKit/stores/conn.ts#L46-L81)
- [ChatUIKit/types/index.ts](file://ChatUIKit/types/index.ts#L12-L12)
...
- [ChatUIKit/stores/conn.ts](file://ChatUIKit/stores/conn.ts#L68-L81)
...
**章节来源**
- [ChatUIKit/stores/chat.ts](file://ChatUIKit/stores/chat.ts#L82-L88)
...
**更新** 本次更新增强了SDK实例跟踪机制，区分chatConn连接实例和chatSDK SDK静态实例，提供了更完善的连接状态管理。建议在后续版本中进一步完善自动重试与心跳策略的配置化，以增强复杂网络环境下的稳定性。
