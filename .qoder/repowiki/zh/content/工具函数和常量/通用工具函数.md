...
- **UUID生成**：generateUUID、generateMessageId
...
## 项目结构
工具函数集中于 ChatUIKit/utils/index.ts，配套常量与类型定义分别位于 ChatUIKit/const/emoji.ts、ChatUIKit/types/index.ts、ChatUIKit/locales/index.ts。多个模块组件通过 import 方式使用这些工具函数，如消息项渲染、表情选择器、编辑器、索引列表等。Vue2版本提供了更丰富的工具函数集合，包括约40+实用函数。

```mermaid
graph TB
Utils["工具函数模块<br/>ChatUIKit/utils/index.ts"]
Vue2Utils["Vue2工具函数集合<br/>vue2-demo/ChatUIKit/utils/index.js"]
...
- [vue2-demo/ChatUIKit/utils/index.js](file://vue2-demo/ChatUIKit/utils/index.js#L1-L776)
...
**章节来源**
- [ChatUIKit/utils/index.ts](file://ChatUIKit/utils/index.ts#L6-L343)
- [vue2-demo/ChatUIKit/utils/index.js](file://vue2-demo/ChatUIKit/utils/index.js#L408-L776)
- [ChatUIKit/utils/permission.js](file://ChatUIKit/utils/permission.js#L1-L272)
...
F13["debounce"]
F14["generateUUID"]
F15["generateMessageId"]
F16["getFileExtension"]
F17["getFileIconType"]
F18["formatFileSize"]
F19["truncateText"]
F20["parseUrlParams"]
...
**图表来源**
- [ChatUIKit/utils/index.ts](file://ChatUIKit/utils/index.ts#L199-L265)
...
**章节来源**
- [vue2-demo/ChatUIKit/utils/index.js](file://vue2-demo/ChatUIKit/utils/index.js#L425-L776)
- [ChatUIKit/utils/permission.js](file://ChatUIKit/utils/permission.js#L1-L272)
...
Vue2Utils["vue2-demo/utils/index.js"]
...
- **表情常量映射参考**：emoji.map、emojiAltMap
  - [ChatUIKit/const/emoji.ts](file://ChatUIKit/const/emoji.ts#L55-L127)
