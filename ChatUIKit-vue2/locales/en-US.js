...
export default {
  ...
  chat: {
    ...
    recordingCancel: 'Release to Cancel',
    recordingTooShort: 'Recording too short',
    imageMaxSize: 'Image size cannot exceed {size}',
    ...
    otherRecalled: '{user} recalled a message',
  ...
  contact: {
    ...
    remark: 'Remark',
    remarkPlaceholder: 'Set remark name',
    ...
    accepted: 'Added',
    declined: 'Declined',
    requestAccepted: '{user} accepted your friend request',
    requestDeclined: '{user} declined your friend request',
  ...
  group: {
    ...
    inviteConfirm: 'Approval Required',
    inviteFree: 'Free Join',
    ...
    confirmDissolve: 'Are you sure to dissolve this group?',
    confirmExit: 'Are you sure to leave this group?',
    confirmKick: 'Are you sure to remove {user}?'
  },
